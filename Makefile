...
install:
	...
	cp create_config.py $(INSTALLDIR)/create_config ;  chmod u+x,g+x,o+x $(INSTALLDIR)/create_config
	cp obsinfo.py $(INSTALLDIR)/obsinfo ;  chmod u+x,g+x,o+x $(INSTALLDIR)/obsinfo
...
clean:
	...
	rm -f $(INSTALLDIR)/create_config
	rm -f $(INSTALLDIR)/obsinfo
