...
if DM is not None:
    ...
    PathToFlag = "/data1/franz/fetch/" + TelName + ".flag_" + str(f_min) + "-" + str(f_max) + "MHz_" + str(NbrOfChan_FFT) + "chan"
    CreateConfig = "create_config.py -i " + VexFile + " -s " + SourceName + " -t " + TelName + " -N " + str(NbrOfJobs) + " -d " + str(DownSamp) + " -n " + str(ChanPerIF) + " -S " + str(ScanNbr) + " -F " + PathToFlag + " --search" + " -o " + ConfigFile
    ...
    #os.system(SubmitJob)
#else:
    #print(SourceName + " is a reference scan.")
