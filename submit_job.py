...
# Add something to handle very bright pulsars?
    MaxNbrOfChan = 2**13
    ...
    CreateConfig = dir + "create_config.py -i " + ExpName + ".vex -s " + SourceName + " -t " + TelName + " -N " + str(NbrOfJobs) + " -d " + str(DownSamp) + " -n " + str(ChanPerIF) + " -S " + str(ScanNbr) + " -F " + PathToFlag + " --online" + " -o " + ConfigFile
